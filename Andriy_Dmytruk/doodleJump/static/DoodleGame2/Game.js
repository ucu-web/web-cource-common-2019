...
export class BreakingPlatform {
    ...
    createElement() {
        ...
        this.right= new Element("platform__breaking-right").insertInto(this.element);
    }
...
export class PlatformDisappearing  {
    ...
    createElement() {
        this.element = new Element("platform__disappearing").insertInto(this.element);
        this.visible = true;
    }
...
export default class Game {
    createElements(container) {
        this.game = new Element("game").insertInto(container);
        let background = new Element("field__background").insertInto(this.game);
        this.field = new Element("field").dimensions(this.width, this.height).insertInto(background);
    }
