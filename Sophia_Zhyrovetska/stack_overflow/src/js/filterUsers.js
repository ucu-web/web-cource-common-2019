import {
  ...
  render,
  delegateEvent, buttonGroupChangeState
...
const buttonsSelectors = [".Button-group__button--reputation", ".Button-group__button--new-users",".Button-group__button--voters", ".Button-group__button--editors", ".Button-group__button--moderators"];
...
const initUsersHandlers = () => {
  nav.addEventListener("click", ev => {
    if (ev.target.matches(".Button-group__button--reputation")) {
      ...
      buttonGroupChangeState(nav, ".Button-group__button--reputation",buttonsSelectors,"Button-group__button--current" );
    ...
    if (ev.target.matches(".Button-group__button--new-users")) {
      ...
      buttonGroupChangeState(nav, ".Button-group__button--new-users",buttonsSelectors,"Button-group__button--current" );
      localStorage.setItem("buttonGroupUsers", nav.innerHTML);
    }
    ...
    if (ev.target.matches(".Button-group__button--voters")) {
      ...
      buttonGroupChangeState(nav, ".Button-group__button--voters",buttonsSelectors,"Button-group__button--current" );
      localStorage.setItem("buttonGroupUsers", nav.innerHTML);
    }
    if (ev.target.matches(".Button-group__button--editors")) {
      ...
      buttonGroupChangeState(nav, ".Button-group__button--editors",buttonsSelectors,"Button-group__button--current" );
      localStorage.setItem("buttonGroupUsers", nav.innerHTML);
    }
    if (ev.target.matches(".Button-group__button--moderators")) {
      ...
      buttonGroupChangeState(nav, ".Button-group__button--moderators",buttonsSelectors,"Button-group__button--current" );
      localStorage.setItem("buttonGroupUsers", nav.innerHTML);
    }
  });
};
